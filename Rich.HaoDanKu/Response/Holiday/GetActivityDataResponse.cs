...
{
    /// <summary>
    /// 节日版块API-38女王节（活动已结束）返回参数
    /// </summary>
    public class GetActivityDataResponse: HaoDanKuResponse
    {
        [JsonPropertyName("data")]
        public List<GetActivityDataData > Data { get; set; }
    }

    public class GetActivityDataData
    {
        /// <summary>
        /// 自增ID
        /// </summary>
