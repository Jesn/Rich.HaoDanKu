...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 拼多多超级搜索返回参数
    /// </summary>
    public class PddGoodsSearchResponse: HaoDanKuResponse
    {
        [JsonPropertyName("data")]
        public List<PddGoodsSearchData > Data { get; set; }
    }

    public class PddGoodsSearchData
    {
        /// <summary>
        /// 拼多多商品ID
        /// </summary>
        ...
        /// <summary>
        /// 数据来源：haodanku（来自好单库精选京东商品数据），pdd（来自多多进宝商品数据）
        /// </summary>
