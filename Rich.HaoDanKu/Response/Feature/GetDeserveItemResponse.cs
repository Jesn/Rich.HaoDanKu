...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 今日值得买API返回参数
    /// </summary>
    public class GetDeserveItemResponse: HaoDanKuResponse
    {
        [JsonPropertyName("item_info")]
        public List<GetDeserveItemData > Data { get; set; }
    }

    public class GetDeserveItemData
    {
        ...
        public string Couponreceive2 { get; set; }
