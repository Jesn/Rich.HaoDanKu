...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 定向计划商品API返回参数
    /// </summary>
    public class GetOrienteeringitemsResponse: HaoDanKuResponse
    {
        [JsonPropertyName("data")]
        public List<GetOrienteeringitemsData > Data { get; set; }
    }

    public class GetOrienteeringitemsData
    {
        /// <summary>
        /// 自增ID
        /// </summary>
        ...
        /// 双十一定金抵扣金额
        /// </summary>
        [JsonPropertyName("deposit_deduct")]
        public float DepositDeduct { get; set; }

        /// <summary>
        /// 是否包邮商品：1为是
        /// </summary>
        [JsonPropertyName("is_shipping")]
        public int IsShipping { get; set; }

        /// <summary>
        /// 定向计划佣金比例
        /// </summary>
        [JsonPropertyName("dx_rates")]
        public float DxRates { get; set; }

        /// <summary>
        /// 定向计划链接
        /// </summary>
        [JsonPropertyName("tkurl")]
