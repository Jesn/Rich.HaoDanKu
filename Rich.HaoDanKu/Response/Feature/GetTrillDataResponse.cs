...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 抖货商品API返回参数
    /// </summary>
    public class GetTrillDataResponse: HaoDanKuResponse
    {
        [JsonPropertyName("data")]
        public List<GetTrillDataData > Data { get; set; }
    }

    public class GetTrillDataData
    {
        /// <summary>
        /// 自增ID
        /// </summary>
        ...
        /// 昨日销量（选择昨日爆单榜才有该字段）
        /// </summary>
        [JsonPropertyName("yesterdaysale")]
        public int Yesterdaysale { get; set; }
        ...
        /// 抖音商品ID
        /// </summary>
        [JsonPropertyName("dy_trill_id")]
        public int DyTrillId { get; set; }

        /// <summary>
        /// 抖音视频地址
        /// </summary>
        [JsonPropertyName("dy_video_url")]
        public string DyVideoUrl { get; set; }

        /// <summary>
        /// 抖音视频点赞数
        /// </summary>
        [JsonPropertyName("dy_video_like_count")]
        public int DyVideoLikeCount { get; set; }

        /// <summary>
        /// 抖音视频分享量
        /// </summary>
        [JsonPropertyName("dy_video_share_count")]
        public int DyVideoShareCount { get; set; }
        ...
        /// 抖音视频标题
        /// </summary>
        [JsonPropertyName("dy_video_title")]
