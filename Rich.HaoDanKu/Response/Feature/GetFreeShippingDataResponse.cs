...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 偏远地区包邮商品API返回参数
    /// </summary>
    public class GetFreeShippingDataResponse: HaoDanKuResponse
    {
        [JsonPropertyName("data")]
        public List<GetFreeShippingDataData > Data { get; set; }
    }

    public class GetFreeShippingDataData
    {
        /// <summary>
        /// 自增ID
        /// </summary>
        ...
        public int YsylTljFace { get; set; }
