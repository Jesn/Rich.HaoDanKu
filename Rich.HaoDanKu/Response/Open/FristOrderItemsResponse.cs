...
namespace Rich.HaoDanKu.Response
{
    ...
    /// 首单礼金商品API返回参数
    /// </summary>
    public class FristOrderItemsResponse: HaoDanKuResponse
    {
        [JsonPropertyName("top_data")]
        public List<TopData> TopData { get; set; }

        [JsonPropertyName("data")]
        public List<FristOrderItemsData> Data { get; set; }
    }
    ...
    public class TopData
    {
       ...
       public class FristOrderItemsData
    {
        /// <summary>
        /// 自增ID
        /// </summary>
        ...
        /// 首单礼金金额
        /// </summary>
        [JsonPropertyName("frist_order")]
        public float FristOrder { get; set; }
